...
class OpenAIProvider(ModelProvider):
    """Provider for OpenAI models (GPT-4.1, GPT-5.2, etc.)."""
    ...
    def _create_pipeline(self):
        """Create Haystack pipeline with OpenAI generator and tools."""
        ...
        try:
            while iteration < max_iterations:
                ...
                if has_tool_calls(reply):
                    # Extract tool calls from the reply using the new format
